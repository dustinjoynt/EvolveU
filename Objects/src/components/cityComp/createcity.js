		...
		return(
			<div>
				...
				<div className='cityForm'>
					...
					<input id='cityLat' className='cityInput' placeholder='Latitude' onChange={this.props.handleChange}></input>
					<input id='cityLon' className='cityInput' placeholder='Longitude' onChange={this.props.handleChange}></input>
